    ...
    <div class="main-card">
        ...
        <div class="side-side">
            ...
            <div class="info-wrapper">
                ...
                <h1>
                    <span class="name text-slate-800 font-bold font-mono">Torreverde</span>
                    <br>
                    <span class="name text-slate-800 font-semibold font-mono">Leonard Bryan</span>                    
                </h1>
                <p class="text-slate-800 font-mono mt-5">Fresh Grad. Exploring and honing</p>
            </div>
        </div>

        <div class="bottom-wrapper">
            <a href="https://discordapp.com/users/395826816721354763" class="link discord" id="discord" type="button">
                ...
                <span class="tooltip-text">buntasaburo</span>
            </a>
            <a href="https://steamcommunity.com/id/allyouneedtodoisstickittotheman/" class="link steam" id="steam">
                ...
                <span class="tooltip-text">Lionhard</span>
            </a>

            <a href="#" class="link battlenet" id="battlenet">
                ...
                <span class="tooltip-text">buntasaburo#3257</span>
            </a>
            <a href="https://www.reddit.com/user/madbytez" class="link reddit" id="reddit">
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    <path
                ...
                <span class="tooltip-text">madbytez</span>
            </a>
        </div>
...
.tooltip-text {
    ...
    transform: translate(-2.70rem, 1.4rem);
}
